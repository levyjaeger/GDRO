...
3. The simulation and the ICU dataset analyses can be run independently of each other. For the ICU analyses, navigate to the folder `scripts/icumodels`. 
	...
	- After the desired models files have been run, the average losses over all boosting iterations and the weights after the last boosting iteration need to be collected for figure generation. 
