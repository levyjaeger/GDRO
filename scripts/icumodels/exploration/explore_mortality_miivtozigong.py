...
plotdir = REPO_ROOT / "exploration" / "icu" / f"{source}to{target}_{outcome}/"
modeldir =  REPO_ROOT / "exploration" / "icu" / f"/{source}to{target}_{outcome}/"
tabledir = REPO_ROOT / "exploration" / "icu" / f"{source}to{target}_{outcome}/"
